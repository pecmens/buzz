...
import { getAdminPosts, deletePost, batchUpdatePostStatus, AdminPost } from '@/lib/admin-posts';
...
export default function PostsList() {
  ...
  const handleBatchAction = async (action: string) => {
    ...
    try {
      ...
      switch (action) {
        case 'publish':
          result = await batchUpdatePostStatus(selectedPosts, 'published');
          break;
        case 'draft':
          result = await batchUpdatePostStatus(selectedPosts, 'draft');
          break;
        case 'archive':
          result = await batchUpdatePostStatus(selectedPosts, 'archived');
          break;
        default:
          return;
      }
